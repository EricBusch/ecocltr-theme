		...
		array(
			...
			'fields'   => array(
				...
				array(
					...
					'type'          => 'textarea',
					'instructions'  => __( 'Short description that appears in the footer below the business name.',
						'ecocltr' ),
					'rows'          => 3,
					'default_value' => __( 'Creating sustainable, beautiful outdoor spaces across southern Ontario.',
						'ecocltr' ),
				),
				array(
					...
					'rows'          => 3,
					'default_value' => __( 'We proudly serve southern Ontario, from Owen Sound in the west to Collingwood in the east, and as far south as Markdale.',
						'ecocltr' ),
				),
				array(
				...
				array(
					...
					'rows'          => 2,
					'default_value' => __( 'Let\'s discuss how we can bring your vision to life with sustainable, nature-forward landscaping.',
						'ecocltr' ),
				),
				array(
				...
				array(
					...
					'name'          => 'cf7_form_id',
					'type'          => 'number',
					'instructions'  => __( 'The ID of the Contact Form 7 form to display on the contact page. Find this in Contact > Contact Forms.',
						'ecocltr' ),
					'default_value' => 30,
					'min'           => 1,
				),
		...
		array(
			...
			'fields'   => array(
				...
				array(
					...
					'type'                 => 'relationship',
					'instructions'         => __( 'Select other services that are related or complementary to this one. The relationship works both ways - if you link Service A to Service B, Service B will automatically show Service A as related.',
						'ecocltr' ),
				...
				array(
					...
					'type'                 => 'relationship',
					'instructions'         => __( 'Projects that feature this service. This field is automatically updated when linking services to projects.',
						'ecocltr' ),
		...
		array(
			...
			'fields'   => array(
				...
				array(
					...
					'name'          => 'hero_video',
					'type'          => 'file',
					'instructions'  => __( 'Upload an MP4 video for the hero background. Recommended: short, looping video without audio.',
						'ecocltr' ),
					'return_format' => 'id',
					'mime_types'    => 'mp4,webm',
				),
				...
				array(
					...
					'instructions'  => __( 'Short description below the heading.', 'ecocltr' ),
					'rows'          => 2,
					'default_value' => __( 'Whether you want to attract pollinators, manage stormwater naturally, or restore your property\'s ecology, we have the expertise to make it happen.',
						'ecocltr' ),
				),
				array(
