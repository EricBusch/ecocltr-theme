...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Averia+Serif+Libre:wght@700&family=Lato:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&display=swap" rel="stylesheet">
	<?php wp_head(); ?>
</head>
				...
				<?php if ( $has_contact_info ) : ?>
					<div class="flex items-center gap-4">
						<?php if ( $business_phone ) : ?>
							<a href="tel:<?php echo esc_attr( preg_replace( '/[^0-9+]/', '', $business_phone ) ); ?>" class="flex items-center gap-1.5 text-white/80 hover:text-white transition-colors">
