<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="relative pt-16 before:absolute before:top-0 before:left-0 before:h-px before:w-6 before:bg-zinc-950 after:absolute after:top-0 after:right-0 after:left-8 after:h-px after:bg-zinc-950/10">
		<div class="relative lg:-mx-4 lg:flex lg:justify-end">
			...
			<a class="!no-underline mt-8 inline-flex rounded-full bg-zinc-950 px-4 py-1.5 text-sm font-semibold text-white transition hover:bg-zinc-800" aria-label="<?php echo esc_attr( sprintf( /* translators: %s: Post title */ __( 'Read more: %s', 'ecocltr' ), get_the_title() ) ); ?>" href="<?php the_permalink(); ?>">
