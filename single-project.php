								...
								<div class="mt-12">
									...
									<div class="grid grid-cols-2 md:grid-cols-3 gap-4">
										...
										foreach ( $gallery_images as $image ) :
											...
											$image_description = wp_get_attachment_caption( $image_id );

											// Build caption text for lightbox with title above description.
											$caption_html = '';
											if ( $image_title && $image_description ) {
												$caption_html = '<strong>' . $image_title . '</strong><br>' . $image_description;
											} elseif ( $image_title ) {
												$caption_html = '<strong>' . $image_title . '</strong>';
											} elseif ( $image_description ) {
												$caption_html = $image_description;
											}
											?>
											<a
